...
if [[ -n "${reuse_tmp}" ]]; then
    ...
    # See https://github.com/enjoy-digital/litedram/blob/master/litedram/core/controller.py
...
hazard3_system_clock_hz=40000000
litedram_sys_clock_hz=60000000
ddr_clock_hz=120000000
